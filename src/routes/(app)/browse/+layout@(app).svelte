<script lang="ts">
  ...
  type browseTypeItems = { title: string; value: string };
  ...
  const browseTypes: browseTypes = {
    anime: { title: "Anime", value: "anime" },
    manga: { title: "Manga", value: "manga" },
    characters: { title: "Characters", value: "characters" },
    staff: { title: "Staff", value: "staff" },
  };
  const browseTypeItems: browseTypeItems[] = Object.values(browseTypes);
