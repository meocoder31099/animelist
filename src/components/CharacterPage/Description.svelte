...
<div class="w-full flex flex-col gap-8 justify-center mt-20 mb-6">
  ...
  {:else if isSuccess}
    <div class="w-full max-w-7xl flex flex-col lg:flex-row gap-6 p-4 mx-auto">
      <div class="w-52 h-52 shrink-0 mx-auto">
        <Avatar src={source.image.large} />
      </div>
    ...
    <div in:fade class="w-full bg-neutral-900 p-4 md:p-8">
      <div
        class="max-w-6xl 3xl:max-w-[1520px] w-full flex gap-4 md:gap-6 3xl:gap-8 mx-auto"
      >
        <div
    ...
    <!-- <div in:fade class="max-w-6xl 3xl:max-w-[1520px] mx-auto w-full grid grid-cols-12 gap-8">
      <div class="col-span-2" />
      <div class="col-span-10">
        <div class="flex flex-col gap-y-4">
          <div class="flex flex-wrap gap-y-2 items-center">
            <div class="bg-rose-500 py-0.5 px-1.5 rounded-lg inline-flex items-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                class="fill-current w-4 h-4"
...
<div class="w-full flex flex-col gap-8 justify-center mt-20 mb-12">
  {#if isLoading}
    <div class="w-full bg-neutral-900 py-8 ">
      <div class="max-w-6xl 3xl:max-w-[1520px] mx-auto w-full grid grid-cols-12 gap-8">
    ...
    <div class="w-full max-w-6xl 3xl:max-w-[1520px] mx-auto grid grid-cols-12 gap-8">
      <div class="col-span-2" />
        ...
        <div class="flex flex-col gap-y-4">
          ...
          <div class="flex flex-col">
            <div class="flex gap-x-1">
              <div class="w-1/6 mb-1.5 h-6 bg-neutral-800 rounded" />
              <div class="w-1/6 mb-1.5 h-6 bg-neutral-800 rounded" />
              <div class="w-1/6 mb-1.5 h-6 bg-neutral-800 rounded" />
              <div class="w-1/6 mb-1.5 h-6 bg-neutral-800 rounded" />
              <div class="w-1/6 mb-1.5 h-6 bg-neutral-800 rounded" />
  ...
  {:else if isSuccess}
    <div in:fade class="w-full bg-neutral-900 p-4 md:p-8">
      <div class="max-w-6xl 3xl:max-w-[1520px] w-full flex gap-4 md:gap-6 3xl:gap-8 mx-auto">
        <div class="w-[90px] md:w-[180px] shrink-0 flex flex-col gap-4 relative">
          <div class="absolute inset-0 aspect-w-2 aspect-h-3">
            <div class="w-full h-full rounded overflow-hidden">
              <img
                data-lazy={source.image.large}
                use:lazyImage
        ...
        <div class="flex justify-between">
          <div class="flex flex-col gap-y-0.5 md:gap-y-2 relative">
            <h1 class="text-2xl md:text-4xl font-medium">{source.name.userPreferred}</h1>
            <div class="text-sm md:text-lg line-clamp-2">
              {#if source.name.native}
                <span class="last:after:content-[''] after:content-[',_']"
                  >{source.name.native}</span
            ...
            <div class="absolute top-full !mt-10 flex flex-col mt-2 md:gap-1 md:text-lg">
              <div>
                <span class="font-medium mr-2">Gender:</span>{source.gender}
              </div>
              <div>
              ...
              <div><span class="font-medium mr-2">Age:</span>{source.age || "?"}</div>
            </div>
          </div>
        </div>
      </div>
